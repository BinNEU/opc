...
function edit_file_form(){
   ...
   // echo "[$filename]";
	...
	<tr><td><input type=button value=\"".et('Refresh')."\" onclick=\"document.edit_form_refresh.submit()\"><span>   </span><input type=button value=\"".et('SaveFile')."\" onclick=\"go_save()\"></td></tr>
