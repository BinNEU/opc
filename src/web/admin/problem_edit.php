...
<p><?php echo $MSG_Sample_Input?>:<textarea rows=13 name=sample_input cols=50><?php echo htmlentities($row['sample_input'],ENT_QUOTES,"UTF-8")?></textarea>
<?php echo $MSG_Sample_Output?>:<textarea rows=13 name=sample_output cols=50><?php echo htmlentities($row['sample_output'],ENT_QUOTES,"UTF-8")?></textarea></p>
