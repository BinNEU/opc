...
?>
<?php if(isset($eid)){?>
Problem <span class=blue><b><?php echo chr($pid+ord('A'))?></b></span> of Exam <span class=blue><b><?php echo $eid?></b></span><br>
<input id="eid" type='hidden' value='<?php echo $eid?>' name="eid">
<?php }else {?>
