...
<?php include("template/$OJ_TEMPLATE/nav.php");?>	
 ...
 <form  class=form-inline action=lostpassword.php method=post>
<center>
<table width=400 algin=center>
<tr><td width=200><?php echo $MSG_USER_ID?>:<td width=250><input class="form-control search-query" name="user_id" type="text" size=20 required=""></tr>
<tr><td><?php echo $MSG_EMAIL?>:<td><input class="form-control search-query" name="email" type="text" size=20 required=""></tr>
<tr><td><td><input name="submit" class="form-control" style='color: #fff;background-color: #3baeda;border: 1px solid #3baeda;border-radius: 4px;' type="submit" size=10 value="提交">
</tr>
</table>
<center>
</form>
