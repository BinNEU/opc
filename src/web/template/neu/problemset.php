...
<tr class='toprow'>
<th width='1%'></th>
<th width='6%'  class='hidden-xs' style="text-align:center;"><?php echo $MSG_PROBLEM_ID?></th>
<th width='56%'style="text-align:center;"><?php echo $MSG_TITLE?></th>
<th class='hidden-xs' width='10%' style="text-align:center;"><?php echo $MSG_SOURCE?></th>
...
<th  width='10%' style="cursor:hand;text-align:center;">知识点</th>
<th  width='7%' class='hidden-xs' style="cursor:hand;text-align:center;">学校</th>
</tr>
</thead>
<tbody>
<?php
