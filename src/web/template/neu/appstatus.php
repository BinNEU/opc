...
<th lay-data="{field:'u9',}" class='hidden-xs'><?php echo $MSG_SUBMIT_TIME?>
...
<div id=center>
				<?php echo "[<a href='appstatus.php?".$str2."'>Top</a>]&nbsp;&nbsp;";
if (isset($_GET['prevtop']))
echo "[<a href='appstatus.php?".$str2."&top=".intval($_GET['prevtop'])."'>Previous Page</a>]&nbsp;&nbsp;";
else
echo "[<a href='appstatus.php?".$str2."&top=".($top+20)."'>Previous Page</a>]&nbsp;&nbsp;";
echo "[<a href='appstatus.php?".$str2."&top=".$bottom."&prevtop=$top'>Next Page</a>]";
?>
</div>
