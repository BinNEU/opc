...
//    <dd><a href="">移动模块</a></dd>
    ...
    $profile.= "<dd><a href=".$path_fix."modifypage.php>$MSG_REG_INFO</a></dd><dd><a href='".$path_fix."userinfo.php?user=$sid'><span id=red>$sid</span></a></dd>";
    ...
    if((isset($OJ_EXAM_CONTEST_ID)&&$OJ_EXAM_CONTEST_ID>0)||
        ...
        $mail=checkmail();
        if($mail) $profile.= "<dd><a class='glyphicon glyphicon-envelope' href=".$path_fix."mail.php>$MSG_MAIL$mail</a></dd>";
    }
