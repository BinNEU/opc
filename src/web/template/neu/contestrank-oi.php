...
<table class=layui-table><thead><tr class=layui-table align=center><td width=5%>Rank<th width=10%>User</th><th width=10%>Nick</th><th width=5%>Solved</th><th width=5%>Penalty</th><th align="center">Mark</th>
<?php
for ($i=0;$i<$pid_cnt;$i++)
