...
<body>
   ...
   <div class="row">
	...
	$codes=str_replace("<","&lt;",$row['code']);
    $codes=str_replace(">","&gt;",$codes);
	$codess=str_replace("<","&lt;",$row['zhuhanshu']);
    $codess=str_replace(">","&gt;",$codess);
    if(strlen($sinput)){
...
<?php 
 if(strlen($codes)||strlen($codess)){
     echo"<h4>本题目仅提交相关函数代码！</h4><br>";
    }
?>
<?php if (isset($id)){?>
...
<?php if (isset($OJ_TEST_RUN)&&$OJ_TEST_RUN&&!isset($cid)){?>
...
<?php }?>
 ...
 <!--<div style="display: block; position: fixed; left: 0px; bottom:0px;width:300px;" class="float_layer" id="miaov_float_layer">
  <div ><a href="<?php echo $path_fix?>wj.html"><img src="<?php echo $cur_path?>/img/wenjuan3.png" style="width: 100%;height: auto;"></a></div>
</div>-->
</body>
</html>
