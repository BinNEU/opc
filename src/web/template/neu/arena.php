...
<div class="container layout layout-margin-top">
    ...
    <div class="row">
		...
		<center><h2><span>擂台列表</span></h2></center>
         <table id='problemlist' width='100%'class="layui-table">
<thead>
<tr class='toprow'>
<th width='5%'  class='hidden-xs' style="text-align:center;">编号</th>
<th width='40%'style="text-align:center;"><?php echo $MSG_TITLE?></th>
<th class='hidden-xs' width='20%' style="text-align:center;">擂主</th>

<th width='10%'  style="cursor:hand;text-align:center;">攻擂</th>
<th width='12%'  style="cursor:hand;text-align:center;">守擂时间</th>
<th width='8%'style="cursor:hand;text-align:center;">被攻次数</th>
...
<div class="sidebox">
	...
	<div class="sidebox-header">
		<h4 class="sidebox-title">我的擂台</h4>
		<?php
    if(isset($_SESSION[$OJ_NAME.'_'.'user_id'])){     $sid=$_SESSION[$OJ_NAME.'_'.'user_id'];?>
<a href="<?php echo $path_fix?>createleitai_page.php" type="button" class="btn btn-success col-md-4 col-xs-6 col-md-offset-1 register-btn" style='color: #fff;background-color: #3baeda;border: 1px solid #3baeda;border-radius: 4px;'>创建擂台</a>															
          <?php }?>
	</div>
