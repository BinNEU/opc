...
<?php echo $MSG_RUNID?>:<input class="form-control" type=text size=4 name=solution_id value='<?php echo  htmlspecialchars($solution_id, ENT_QUOTES) ?>'>
...
<?php if(isset($_SESSION[$OJ_NAME.'_'.'administrator'])||isset($_SESSION[$OJ_NAME.'_'.'source_browser'])||isset($_SESSION[$OJ_NAME.'_'.'problem_editor'])){
...
<?php }?>
	...
	<script src="<?php echo $cur_path?>auto_refresh.js?v=0.34" ></script>
