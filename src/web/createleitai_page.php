...
?>
<form method=POST action=createleitai.php>
...
<p align=left>更多组测试数据，请在题目添加完成后在题目页面点击添加样例补充</p>
...
<p>擂主:<input class="input input-mini" type=text name=source size=20 value=<?php echo $_SESSION[$OJ_NAME.'_'.'user_id']?>>请勿改动，否则题目将不会显示在您的列表内</p>
