...
if(isset($_GET['id'])){
  ...
  if(!isset($_SESSION[$OJ_NAME.'_'.'administrator']))
    $sql="SELECT langmask,private,defunct,exam FROM `contest` WHERE `defunct`='N' AND `contest_id`=? AND `start_time`<='$now'";
  else
    $sql="SELECT langmask,private,defunct,exam FROM `contest` WHERE `defunct`='N' AND `contest_id`=?";
...
/////////////////////////Template
require("template/".$OJ_TEMPLATE."/contestproblem.php");
/////////////////////////Common foot
