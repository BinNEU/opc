...
foreach ($result as $row){
	...
	$view_problemset[$i][4]="<div class='center'>".$row['point']."</div>";
	$view_problemset[$i][5]="<div class='center'>".$row['school']."</div>";
...
require("template/".$OJ_TEMPLATE."/problemlist.php");
