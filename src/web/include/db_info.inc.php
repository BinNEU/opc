...
// connect db 
static 	$DB_HOST="192.168.*.*";  //数据库服务器ip或域名
static 	$DB_NAME="***";   //数据库名
static 	$DB_USER="***";  //数据库账户
static 	$DB_PASS="***";  //数据库密码

static 	$OJ_NAME="东北大学在线编程社区";  //左上角显示的系统名称
static 	$OJ_HOME="./";    //主页目录
...
static  $OJ_TEMPLATE="neu"; //使用的默认模板, [bs3 ie ace sweet sae mario] work with discuss3, [classic bs] work with discuss
